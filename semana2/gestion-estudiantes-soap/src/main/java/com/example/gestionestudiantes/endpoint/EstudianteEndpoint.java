...
public class EstudianteEndpoint {
    ...
    @PayloadRoot(namespace = NAMESPACE_URI, localPart = "CrearCursoRequest")
    @ResponsePayload
    public CrearCursoResponse crearCurso(@RequestPayload CrearCursoRequest request) {
        return estudianteService.crearCurso(request);
    }
